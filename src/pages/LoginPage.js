      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8">
          ...
          <div className="mt-4 space-y-3">
            <button
              type="button"
              className="w-full py-2.5 px-4 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors flex items-center justify-center space-x-2"
              onClick={() => toast("Google login will be configured in production", { icon: "ℹ️" })}
            >
            ...
            <button
              type="button"
              className="w-full py-2.5 px-4 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors flex items-center justify-center space-x-2"
              onClick={() => toast("Facebook login will be configured in production", { icon: "ℹ️" })}
            >
